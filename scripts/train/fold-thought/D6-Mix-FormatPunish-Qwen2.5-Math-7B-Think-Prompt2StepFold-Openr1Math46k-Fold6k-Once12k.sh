...
experiment_name='D6-Mix-FormatPunish-Qwen2.5-Math-7B-Think-Prompt2StepFold-Openr1Math46k-Fold6k-Once12k'
...
val_samples=8 # 8
temperature=1.0
max_prompt_length=10240 # 12288
max_response_length=6144
max_once_prompt_length=4096
max_once_response_length=12288
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.task='mix-fold' $@ # set the task to 'rl' or 'svs'